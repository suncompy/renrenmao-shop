    ...
    public function checkData($type){
        ...
        switch ($type){
            case 1:
                ...
                $data['tax_num'] = I('tax_num');
                $data['title_content'] = I('title_content');
                ...
                $data['_string'] = ' <span>'.$typeName.'&nbsp</span> <span>'
                                  ...
                                  .$conName.'&nbsp</span>';
                $data['rtn'] = $typeName.'&nbsp'.$data['normal_title'].'&nbsp'.$conName.'&nbsp'.$data['tax_num'].'&nbsp'.$data['title_content'];
            break;
            case 2 :
                $data['ele_title'] = I('ele_title');
                $data['ele_content'] = I('ele_content');
                $data['tax_num'] = I('tax_num1');
                $data['title_content'] = I('title_content1');
                $typeName = $invoiceTypes[$type];
                ...
                $data['_string'] = ' <span>'.$typeName.'&nbsp</span> <span>'
                                  ...
                                  .$conName.'&nbsp</span>';
                $data['rtn'] = $typeName.'&nbsp'.$data['ele_title'].'&nbsp'.$conName.'&nbsp'.$data['tax_num'].'&nbsp'.$data['title_content'];
            break;
            case 3:
                $data['unit'] = I('unit');
                $data['code'] = I('code');
