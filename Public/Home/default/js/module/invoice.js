...
define('module/invoice', function(require, exports, module){
  ...
  var invoice = {
    ...
    validation: function(type){
      ...
      /*普通发票内容*/
      normal_title = $('div#invoice-main select[name="normal_title"]').val(),
      tax_num =   $('div#invoice-main input[name="tax_num"]').val(),
      title_content=$('div#invoice-main input[name="title_content"]').val(),
      normal_content = $('div#invoice-main input[name="normal_content"]').val(),
      /*电子发票内容*/
      tax_num1 =   $('div#invoice-main input[name="tax_num1"]').val(),
      title_content1=$('div#invoice-main input[name="title_content1"]').val(),
      ele_title = $('div#invoice-main select[name="ele_title"]').val(),
      ...
      inc_content = $('div#invoice-main select[name="inc_content"]').val();
