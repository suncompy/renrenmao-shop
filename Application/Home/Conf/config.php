...
return array(
   ...
   * 预先加载的标签库
   */
  'TAGLIB_PRE_LOAD' => 'Home\\TagLib\\News,OT\\TagLib\\Article,OT\\TagLib\\Think',
      // 'TAGLIB_BUILD_IN' => 'Cx,Think\Template\TagLib\News'  ,
  /**
   * 主题设置
   */
   ...
   * SESSION 和 COOKIE 配置
   */
  'SESSION_PREFIX' => 'jipushop_home', //session前缀
  'COOKIE_PREFIX'  => 'jipushop_home_', // Cookie前缀 避免冲突
