define('module/common', function(require, exports, module){
  ...
  var common = {
    ...
    /**
     * app分享
     * @param id  商品id 或者店铺id
     */
    shareByApp:function(id){
        ...
        $.post($.U('Api/getShareParameters'), 'id='+id+'&url='+url+'&client='+client, function(res){
            if(isAndroid){
                //安卓调用分享
                window.control.appShareByAndroid2(res);
            }
            if(isiOS){
                //ios调用分享
                appShareByIos2(res);
