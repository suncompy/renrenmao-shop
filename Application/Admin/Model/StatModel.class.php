...
class StatModel extends Model{
  ...
  public function getOrderStatNum($start_date = '', $end_date = ''){
    ...
    //交易成功
    $add_where = array('o_status' => array('in' , '202,205'));
    ...
    //已成交金额
    $shop = $this->field('sum(total_amount) amount')->where('o_status=202 || o_status=205')->where($order_where)->find();
  ...
  function getItemStat($start_date = '', $end_date = ''){
    ...
    //获取订单
    $where = array(
      'o_status' => array('IN', '200, 201, 202,205'),
      'status'=>1,
